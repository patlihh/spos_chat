...
//                    signUpButtonPaint);
            ...
            canvas.drawArc (new RectF(currentLeft - getButtonHeight() / 2 + currentArcX,buttonTop,currentLeft + getButtonHeight() / 2 - currentArcX,buttonBottom), 0, 360, false, signUpButtonPaint);
