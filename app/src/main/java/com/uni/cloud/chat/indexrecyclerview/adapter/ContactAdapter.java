...
package com.uni.cloud.chat.indexrecyclerview.adapter;
...
import com.uni.cloud.chat.indexrecyclerview.UniRecylerActivity;
import com.uni.cloud.chat.indexrecyclerview.lib.adapter.BaseAdapter;
import com.uni.cloud.chat.indexrecyclerview.lib.adapter.expand.StickyRecyclerHeadersAdapter;
import com.uni.cloud.chat.indexrecyclerview.lib.widget.SwipeItemLayout;
import com.uni.cloud.chat.indexrecyclerview.model.ContactModel;
import com.uni.cloud.chat.indexrecyclerview.widget.IndexAdapter;
        ...
        if (getItem(position).getId().equals(OWNER)) {
            ...
            holder.mDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((UniRecylerActivity) mContext).deleteUser(position);
                }
            });
        } else {
