...
jint Java_com_uni_cloud_chat_audio_Opus_open(JNIEnv *env,jobject thiz,jint compression){
...
JNIEXPORT
jint Java_com_uni_cloud_chat_audio_Opus_getFrameSize(JNIEnv *env,jobject thiz)
{
    return  FRAME_SIZE;
}
//压缩
JNIEXPORT
jint Java_com_uni_cloud_chat_audio_Opus_encode(JNIEnv *env,jobject thiz,    jshortArray lin, jint offset, jbyteArray encoded, jint size)
{
    int err;
    int i;
    int nbBytes;
...
//解压
JNIEXPORT
jint Java_com_uni_cloud_chat_audio_Opus_decode(JNIEnv *env,jobject thiz, jbyteArray encoded, jshortArray lin, int size)
{
    int err;
    int i;
    int frame_size;
...
//释放语音对象
JNIEXPORT
void Java_com_uni_cloud_chat_audio_Opus_close(JNIEnv *env,jobject thiz)
{
