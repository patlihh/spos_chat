...
extern "C"
JNIEXPORT jint JNICALL Java_com_uni_cloud_chat_audio_Speex_open(JNIEnv *env, jobject obj, jint compression) {
    int tmp;
    ...
    LOGD("open enc_frame_size=%d; dec_frame_size=%d",enc_frame_size, dec_frame_size);
...
//   preprocess_state = speex_preprocess_state_init(640, 16000);//创建预处理对象
...
extern "C"
JNIEXPORT jint JNICALL Java_com_uni_cloud_chat_audio_Speex_encode
    ...
    LOGD("encode enc_frame_size=%d; size=%d; nSamples=%d",enc_frame_size, size, nSamples);
...
extern "C"
JNIEXPORT jint JNICALL Java_com_uni_cloud_chat_audio_Speex_decode
...
extern "C"
JNIEXPORT jint JNICALL Java_com_uni_cloud_chat_audio_Speex_getFrameSize
...
extern "C"
JNIEXPORT void JNICALL Java_com_uni_cloud_chat_audio_Speex_close
    (JNIEnv *env, jobject obj) {
